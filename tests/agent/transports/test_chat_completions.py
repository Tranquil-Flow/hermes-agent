...
class TestChatCompletionsBuildKwargs:
    ...
    def test_confirmed_ollama_keeps_default_when_num_ctx_probe_fails(self, transport):
        """Ollama identity must survive an unsuccessful /api/show probe."""
        from providers import get_provider_profile
